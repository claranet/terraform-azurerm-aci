...
* **tflint:** 🐛 bump Azure rules version, fix signature bug 462d24b

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 92e5f65
* **deps:** update dependency opentofu to v1.12.2 dd950b1
* **deps:** update dependency opentofu to v1.12.3 43d2c68
* **deps:** update dependency opentofu to v1.12.4 a7561ff
* **deps:** update dependency tflint to v0.63.1 4a158b9
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 18a9b73
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 0c0e93f

## 8.0.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 1f83515

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu 8920b29
* **deps:** update dependency opentofu to v1.11.7 61255c0
* **deps:** update dependency opentofu to v1.12.0 b200b26
* **deps:** update dependency terraform-docs to v0.23.0 c83dfbb
* **deps:** update dependency terraform-docs to v0.24.0 122aa15
* **deps:** update dependency tflint to v0.62.1 80fb180
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 8e92e46
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 e599ebe
* **deps:** update tools be09395
* **pre-commit:** 🔧 move to prek fd95167
* **tfdocs:** bump tfdocs to v0.22 🔧 5eadcab

## 8.0.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ e0cc6e4

### Code Refactoring

* update module structure and Github actions 👷 aa08107

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 25a074f
* **deps:** 🔗 bump tflint rules version 58ee460
* **deps:** 🔗 bump tflint rules version 1c47e8d
* **deps:** update dependency trivy to v0.69.2 9326fd0
* **deps:** update dependency trivy to v0.69.3 4798703
* **deps:** update dependency trivy to v0.69.4 a662172
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 b51a710

### Revert

* chore(deps): update dependency trivy to v0.69.4 🔒️ a9849c6

## 8.0.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 b948556

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 14a3662
* **deps:** update dependency opentofu to v1.11.2 e328dd6
* **deps:** update dependency opentofu to v1.11.3 fe84baf
* **deps:** update dependency opentofu to v1.11.4 88ba9c2
* **deps:** update dependency opentofu to v1.11.5 1d432ff
* **deps:** update dependency pre-commit to v4.4.0 d5dd4e4
* **deps:** update dependency pre-commit to v4.5.0 f721f59
* **deps:** update dependency pre-commit to v4.5.1 9c0d667
* **deps:** update dependency tflint to v0.60.0 9820c85
* **deps:** update dependency tflint to v0.61.0 631b774
* **deps:** update dependency trivy to v0.67.1 d37083e
* **deps:** update dependency trivy to v0.67.2 ea512bd
* **deps:** update dependency trivy to v0.68.1 a022275
* **deps:** update dependency trivy to v0.68.2 c656287
* **deps:** update dependency trivy to v0.69.0 75fd4c8
* **deps:** update dependency trivy to v0.69.1 6edd80c
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 af3f26f
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 31cd60a
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 f5b03e6
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 781ec24
* **deps:** update tools 83e9048
